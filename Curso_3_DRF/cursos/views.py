...
# # from django.shortcuts import get_object_or_404, podemos fazer dessa maneira mas pegamos direto da biblioteca do rest para garantir a conversão
...
#     #     curso = get_object_or_404(Curso, id)
